...
const SAMPLE_PROJECTS = [
  ...
  { id: 3, title: 'Campus Naturaleza', desc: 'Realice la actualización y mantenimiento del sitio web el cual estaba programado en wordpress. Además de implementar la traducción al idioma inglés.', tech: ['Wordpress', 'SEO', 'Google Analytics'], url: 'https://campusnaturaleza.udec.cl/', img: 'resources/img/CampusNaturaleza.jpeg' },
  ...
  { id: 5, title: 'KGB Logistic', desc: 'Participé en el equipo de informática de KGB, contribuyendo a la optimización del rendimiento y mejoras funcionales de su sitio web. Ademas de implementar una nueva vista para sus certificaciónes.', tech: ['WordPress'], url: 'https://www.kgblogistic.com/', img: 'resources/img/KGB.png' },
  { id: 6, title: 'IHPE LTDA', desc: 'Programé un sitio web para la pyme IHPE LTDA, el cual le permite realizar ventas de productos de aseo y limpieza destinados al hogar en colaboración con un equipo de trabajo compuesto por cuatro integrantes, asumiendo los roles de Jefe de Proyecto y Programador. Como líder del proyecto, coordiné las actividades del equipo, asigné responsabilidades y garantizé que el desarrollo siguiera los objetivos establecidos. Utilizamos WordPress y Woocommerce para crear un sitio web funcional y atractivo. Trabajando en conjunto con el equipo, llevamos a cabo la personalización del diseño, la integración de la plataforma de comercio electrónico, y la optimización del rendimiento del sitio.', tech: ['WordPress','Woocomerce', 'Scrum'], url: 'http://ihpeltda.cl/', img: 'resources/img/IHPE LTDA.jpg'},
