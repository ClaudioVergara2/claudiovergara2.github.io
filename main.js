...
const SAMPLE_PROJECTS = [
  ...
  { id: 4, title: 'ATE CFRD UdeC [En producción]', desc: 'Nueva pagina web de venta de cursos para profesores proporcionados por ATE CFRD UDEC, mediante Wordpress + Woocomerce conectado con Moodle.', tech: ['WordPress', 'Woocomerce', 'Moodle'], url: '#' , img: 'resources/img/ATE.jpg'},
